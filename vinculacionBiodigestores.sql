...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-03-2018 a las 03:50:55
...
(1, 'Prueba Asociacio', 'LMA', 1, '2018-03-07 06:59:56', '2018-03-07 06:59:56', NULL);
...
--
-- Volcado de datos para la tabla `biodigestor`
--

INSERT INTO `biodigestor` (`id`, `ubicacion`, `tamañoPropiedad`, `imagen`, `video`, `anchoBio`, `largoBio`, `profundBio`, `anchoCaja`, `largoCaja`, `profundCaja`, `temperatura`, `UnidadProduccion_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Pacto', 4200, 'asdsadasdas', 'asdasd', '1.8000', '2.4000', '3.2000', '5.2000', '6.4000', '2.4000', 24, 1, '2018-03-07 07:09:56', '2018-03-07 07:09:56', NULL);
...
INSERT INTO `desecho` (`id`, `fecha`, `peso`, `created_at`, `updated_at`, `deleted_at`, `Biodigestor_id`) VALUES
(1, '2018-03-06', '4.0000', '2018-03-07 02:16:32', '2018-03-07 07:16:32', '2018-03-07 07:16:32', 1),
(2, '2018-03-06', '4.5000', '2018-03-07 07:34:18', '2018-03-07 07:34:18', NULL, 1);
...
(1, 'Producto 1', 1, '2018-03-07 07:00:28', '2018-03-07 07:00:28', NULL);
...
(1, 'Asociacion 1', '2018-03-07 06:59:37', '2018-03-07 06:59:37', NULL);
...
(1, 'Tipo Producto 1', '2018-03-07 07:00:14', '2018-03-07 07:00:14', NULL);
...
(1, 'Prueba Biodigestores', '0.1454599152117588', '-78.80709264025882', 'Prueba Biodigestores', 1, 1, '2018-03-07 07:00:53', '2018-03-07 07:00:53', NULL);
...
(1, 'Cristian Jarrin', 'cristian.ja.la@hotmail.com', '$2y$10$sZ4pCc1pazHScPJEYAkUhO8oJlnIXmXjKpu0FAnVIQz3RrYZrqpVa', NULL, '2018-03-07 07:20:02', '2018-03-07 07:20:02');
...
--
-- AUTO_INCREMENT de la tabla `grupoalimentosproductos`
--
ALTER TABLE `grupoalimentosproductos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `tipoagricultura`
--
ALTER TABLE `tipoagricultura`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `tipoalimentosconsumo`
--
ALTER TABLE `tipoalimentosconsumo`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `tiporiesgos`
--
ALTER TABLE `tiporiesgos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
