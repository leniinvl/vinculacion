...
/**
 * Class Taller_Has_TipoRiesgos
 * @package App\Models
 * @version January 19, 2018, 2:33 am UTC
 *
 * @property \App\Models\Taller taller
 * @property \App\Models\Tiporiesgo tiporiesgo
 ...
 * @property integer TipoRiesgos_id
 */
class Taller_Has_TipoRiesgos extends Model
{
    use SoftDeletes;
    ...
    {
        return $this->belongsTo(\App\Models\Tiporiesgo::class);
    }
}
