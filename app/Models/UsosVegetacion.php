 ...
 */
class UsosVegetacion extends Model
{
    use SoftDeletes;

    public $table = 'usosvegetacion';
     ...
     **/
    public function areainfluenciaHasTipovegetals()
    {
        return $this->belongsToMany(\App\Models\AreainfluenciaHasTipovegetal::class, 'usosvegetacion_has_areainfluencia_has_tipovegetal');
    }
}
