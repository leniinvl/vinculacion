 ...
 */
class TipoAlimentosConsumo extends Model
{
    use SoftDeletes;

    public $table = 'tipoalimentosconsumo';
    ...
    {
        return $this->belongsToMany(\App\Models\Planriesgo::class, 'planriesgos_has_tipoalimentosconsumo');
    }
}
