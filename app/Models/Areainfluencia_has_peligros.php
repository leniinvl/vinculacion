 ...
 * @property integer Peligros_id
 */
class Areainfluencia_has_peligros extends Model
{
    use SoftDeletes;
    ...
    {
        return $this->belongsTo(\App\Models\Peligro::class);
    }
}
