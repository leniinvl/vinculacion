...
<div class="input-group"> <span class="input-group-addon fa fa-search" aria-hidden="true"></span>
    <input id="condicionesDrenajes-table" type="text" class="form-control" placeholder="Buscar">
</div>
<section>
...
<table id="condicionesDrenajes-table" style="font-family: Lucida Sans Unicode, Lucida Grande, Sans-Serif;
                font-size: 12px;
                width: 480px;
                margin-left: auto;
                margin-right: auto;
    ...
    @foreach($condicionesDrenajes as $condicionesDrenaje)
        <tr style="font-size: 13px;
            ...
            <td style=" padding: 8px;
                ...
                border-bottom: 1px solid #fff;
                color: #669;
                border-top: 1px solid transparent;">{!! $condicionesDrenaje->nombre !!}</td>
            <td style=" padding: 8px;
                background: #e8edff;
                border-bottom: 1px solid #fff;
                color: #669;
                border-top: 1px solid transparent;">{!! $condicionesDrenaje->valor !!}</td>
...
<script>
  $(document).ready(function () {
     $('#condicionesDrenajes-table').keyup(function () {
...
function printDiv(nombreDiv) {
       ...
       var div1 = document.getElementById('condicionesDrenajes-table');
