...
<div class="input-group"> <span class="input-group-addon fa fa-search" aria-hidden="true"></span>
    <input id="lenguajes-table" type="text" class="form-control" placeholder="Buscar">
</div>
<section>
...
<table id="lenguajes-table" style="font-family: Lucida Sans Unicode, Lucida Grande, Sans-Serif;
                font-size: 12px;
                width: 480px;
                margin-left: auto;
                margin-right: auto;
    ...
    @foreach($lenguajes as $lenguaje)
        <tr style="font-size: 13px;
            ...
            <td style=" padding: 8px;
                ...
                border-bottom: 1px solid #fff;
                color: #669;
                border-top: 1px solid transparent;">{!! $lenguaje->nombre !!}</td>
...
<script>
  $(document).ready(function () {
     $('#lenguajes-table').keyup(function () {
...
function printDiv(nombreDiv) {
       ...
       var div1 = document.getElementById('lenguajes-table');
