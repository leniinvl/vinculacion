<table class="table table-responsive" id="caracteristicasEtnicas-table">
    ...
    <tbody>
    @foreach($caracteristicasEtnicas as $caracteristicasEtnicas)
        <tr>
            <td>{!! $caracteristicasEtnicas->nombre !!}</td>
            <td>
                {!! Form::open(['route' => ['caracteristicasEtnicas.destroy', $caracteristicasEtnicas->id], 'method' => 'delete']) !!}
                <div class='btn-group'>
