...
<table id="climas-table" style="font-family: Lucida Sans Unicode, Lucida Grande, Sans-Serif;
                font-size: 12px;
                width: 480px;
                margin-left: auto;
                margin-right: auto;
    ...
    @foreach($climas as $clima)
        <tr style="font-size: 13px;
            ...
            <td style=" padding: 8px;
                ...
                border-bottom: 1px solid #fff;
                color: #669;
                border-top: 1px solid transparent;">{!! $clima->nombre !!}</td>
            <td style=" padding: 8px;
                background: #e8edff;
                border-bottom: 1px solid #fff;
                color: #669;
                border-top: 1px solid transparent;">{!! $clima->mnsm !!}</td>
...
function printDiv(nombreDiv) {
	 ...
	 <script>
       ...
       var div1 = document.getElementById('climas-table');
