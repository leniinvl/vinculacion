...
var tf2 = setFilterGrid("productos-table ", table2_Props);
</script>
...
<table  id="productos-table" style="font-family: Lucida Sans Unicode, Lucida Grande, Sans-Serif;
                font-size: 12px;
                width: 480px;
                margin-left: auto;
                margin-right: auto;
    ...
    @foreach($productos as $producto)
        <tr style="font-size: 13px;
            ...
            <td style=" padding: 8px;
                ...
                border-bottom: 1px solid #fff;
                color: #669;
                border-top: 1px solid transparent;">{!! $producto->nombre !!}</td>
            <td style=" padding: 8px;
                background: #e8edff;
                border-bottom: 1px solid #fff;
                color: #669;
                border-top: 1px solid transparent;">{!! $producto->tipoproducto->nombre !!}</td>
...
function printDiv(nombreDiv) {
       ...
       var div1 = document.getElementById('productos-table');
