        ...
        <tr>
            ...
            <td>
                ...
                <div class='btn-group'>
                    ...
                    {!! Form::button('<i class="glyphicon glyphicon-trash"></i>', ['type' => 'submit', 'class' => 'btn btn-danger btn-xs', 'onclick' => "return confirm('Está seguro de eliminarlo?')"]) !!}
                    @else
...
var tf2 = setFilterGrid("desechos-table ", table2_Props);
</script>
<!-- area de impresion -->
