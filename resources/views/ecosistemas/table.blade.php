...
<div class="input-group"> <span class="input-group-addon fa fa-search" aria-hidden="true"></span>
    <input id="ecosistemas-table" type="text" class="form-control" placeholder="Buscar">
</div>
<section>
...
<table id="ecosistemas-table" style="font-family: Lucida Sans Unicode, Lucida Grande, Sans-Serif;
                font-size: 12px;
                width: 480px;
                margin-left: auto;
                margin-right: auto;
    ...
    @foreach($ecosistemas as $ecosistema)
        <tr style="font-size: 13px;
            ...
            <td style=" padding: 8px;
                ...
                border-bottom: 1px solid #fff;
                color: #669;
                border-top: 1px solid transparent;">{!! $ecosistema->nombre !!}</td>
...
<script>
  $(document).ready(function () {
     $('#ecosistemas-table').keyup(function () {
...
<script>
       ...
       var div1 = document.getElementById('ecosistemas-table');
