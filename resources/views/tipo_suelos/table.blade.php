...
<div class="input-group"> <span class="input-group-addon fa fa-search" aria-hidden="true"></span>
    <input id="tipoSuelos-table" type="text" class="form-control" placeholder="Buscar">
</div>
<section>
...
<table id="tipoSuelos-table" style="font-family: Lucida Sans Unicode, Lucida Grande, Sans-Serif;
                font-size: 12px;
                width: 480px;
                margin-left: auto;
                margin-right: auto;
    ...
    @foreach($tipoSuelos as $tipoSuelo)
        <tr style="font-size: 13px;
            ...
            <td style=" padding: 8px;
                ...
                border-bottom: 1px solid #fff;
                color: #669;
                border-top: 1px solid transparent;">{!! $tipoSuelo->nombre !!}</td>
...
<script>
  $(document).ready(function () {
     $('#tipoSuelos-table').keyup(function () {
...
function printDiv(nombreDiv) {
   ...
   function cambiaVisibilidad() {
       var div1 = document.getElementById('tipoSuelos-table');
