...
var tf2 = setFilterGrid("tipodesechos-table ", table2_Props);
</script>
<!-- area de impresion -->
...
<table id="tipodesechos-table" style="font-family: Lucida Sans Unicode, Lucida Grande, Sans-Serif;
                font-size: 12px;
                width: 480px;
                margin-left: auto;
                margin-right: auto;
    ...
    <tbody  class="contenidobusqueda">
        ...
        <tr style="font-size: 13px;
                ...
                border-bottom: 1px solid #fff;
                color: #669;
                border-top: 1px solid transparent;">{!! $tipodesecho->nombre !!}</td>
                <td style=" padding: 8px;
                background: #e8edff;
                border-bottom: 1px solid #fff;
                color: #669;
                border-top: 1px solid transparent;">{!! $tipodesecho->descripcion !!}</td>
