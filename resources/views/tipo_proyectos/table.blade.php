...
<h3><center>Tipos de Proyectos</center></h3>
<table id="tipoProyectos-table" style="font-family: Lucida Sans Unicode, Lucida Grande, Sans-Serif;
                font-size: 12px;
                width: 480px;
                margin-left: auto;
                margin-right: auto;
    ...
    @foreach($tipoProyectos as $tipoProyecto)
        <tr style="font-size: 13px;
            ...
            <td style=" padding: 8px;
                ...
                border-bottom: 1px solid #fff;
                color: #669;
                border-top: 1px solid transparent;">{!! $tipoProyecto->nombre !!}</td>
...
function printDiv(nombreDiv) {
   ...
   function cambiaVisibilidad() {
       var div1 = document.getElementById('tipoProyectos-table');
