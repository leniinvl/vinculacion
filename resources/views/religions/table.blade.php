...
<div class="input-group"> <span class="input-group-addon fa fa-search" aria-hidden="true"></span>
    <input id="religions-table" type="text" class="form-control" placeholder="Buscar">
</div>
<section>
...
<table id="religions-table" style="font-family: Lucida Sans Unicode, Lucida Grande, Sans-Serif;
                font-size: 12px;
                width: 480px;
                margin-left: auto;
                margin-right: auto;
    ...
    @foreach($religions as $religion)
        <tr style="font-size: 13px;
            ...
            <td style=" padding: 8px;
                ...
                border-bottom: 1px solid #fff;
                color: #669;
                border-top: 1px solid transparent;">{!! $religion->nombre !!}</td>
...
<script>
  $(document).ready(function () {
     $('#religions-table').keyup(function () {
...
function printDiv(nombreDiv) {
       ...
       var div1 = document.getElementById('religions-table');
