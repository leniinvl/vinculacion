...
<div class="input-group"> <span class="input-group-addon fa fa-search" aria-hidden="true"></span>
    <input id="tipoVegetals-table" type="text" class="form-control" placeholder="Buscar">
</div>
<section>
...
<table id="tipoVegetals-table" style="font-family: Lucida Sans Unicode, Lucida Grande, Sans-Serif;
                font-size: 12px;
                width: 480px;
                margin-left: auto;
                margin-right: auto;
    ...
    <thead>
        <tr style="font-size: 13px;
            ...
            <th style="background: #d0dafd;
                color: #339;">Nombre Comun</th>
        <th style="background: #d0dafd;
                color: #339;">Nombre Cientifico</th>
    ...
    @foreach($tipoVegetals as $tipoVegetal)
        <tr style="font-size: 13px;
            ...
            <td style=" padding: 8px;
                ...
                border-bottom: 1px solid #fff;
                color: #669;
                border-top: 1px solid transparent;">{!! $tipoVegetal->nombre_comun !!}</td>
            <td style=" padding: 8px;
                background: #e8edff;
                border-bottom: 1px solid #fff;
                color: #669;
                border-top: 1px solid transparent;">{!! $tipoVegetal->nombre_cientifico !!}</td>
...
<script>
  $(document).ready(function () {
     $('#tipoVegetals-table').keyup(function () {
...
function printDiv(nombreDiv) {
       ...
       var div1 = document.getElementById('tipoVegetals-table');
